...
function Card({ name, desc, link }) {
    return (
        <div
            className='flex flex-col items-start justify-between gap-4 w-96 border border-gray-300 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl duration-300 ease-in-out min-h-48 max-h-48 relative overflow-hidden hover:bg-gradient-to-br from-gray-100 to-gray-200'
            style={{
